...
description: >-
  Read-only Claude review lane for the Parallax pipeline. The router injects this agent
  when parallax.yaml assigns a review/plan role to the `claude` engine. Use for an
