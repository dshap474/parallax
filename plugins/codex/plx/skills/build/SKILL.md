...
- Write `Implementation: 1× fresh codex (gpt-5.6-sol high) owns implement · review: 3×1 (grok-4.6 medium, worker-run) · fixes: worker · verification: full relevant suite (worker-run) · host: bootstrap + gate`
