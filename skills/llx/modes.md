...
This file defines exact workflows. `router.md` chooses the mode.
...
- Store prompts, logs, outputs, findings, specs, diffs, and final results in `.parallax/runs/<run-id>/`.
...
6. Do not edit unless the user explicitly asked for fixes.
